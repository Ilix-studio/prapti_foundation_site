...
const EditorPlayVideo: React.FC = () => {
    ...
    <div className='min-h-screen bg-linear-to-br from-slate-50 to-white'>
      ...
      <div className='sticky top-0 z-40 w-full border-b bg-white/95 backdrop-blur'>
        <div className='container flex h-16 items-center justify-between px-4'>
          <Button variant='ghost' onClick={() => navigate(VIDEOS_ROUTE)}>
          ...
          <div className='flex items-center gap-2'>
            <Button
              variant='outline'
              size='sm'
              onClick={() => navigate(`${VIDEOS_ROUTE}/edit/${video._id}`)}
            >
...
export default EditorPlayVideo;
